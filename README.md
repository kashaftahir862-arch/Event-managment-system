...
​Event  Management: Tools to create events and handle  bookings or registration.   
​. Manage events date and time 
​Guest &   registration Management: Keeping track of event guests and logging basic of users.
​Feedback System: A module for user queries and contact forms.
And logout Design   
